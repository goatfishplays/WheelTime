...
private:
    ...
    void populateKeystrokeKeyCombo();
    ...
    bool m_isRecordingKeystroke{false};
    ...
    QCheckBox *m_keystrokeCtrlCheck{nullptr};
    QCheckBox *m_keystrokeAltCheck{nullptr};
    QCheckBox *m_keystrokeShiftCheck{nullptr};
    QCheckBox *m_keystrokeWinCheck{nullptr};
    QComboBox *m_keystrokeKeyCombo{nullptr};
    QDoubleSpinBox *m_keystrokeHoldSpin{nullptr};
    QCheckBox *m_keystrokeProceedCheck{nullptr};
